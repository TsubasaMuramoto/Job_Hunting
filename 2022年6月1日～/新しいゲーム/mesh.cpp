...
//// コンストラクタ
////=============================================================================
//CMesh::CMesh(OBJTYPE nPriority) : CScene(nPriority)
//{
//	// 各種初期化
...
//// インスタンス生成処理
////---------------------------------------------------------------
//CMesh *CMesh::Create(D3DXVECTOR3 pos, D3DXVECTOR3 size, D3DXVECTOR3 rot, int nLine, int nVertical)
//{
//	// インスタンス生成
//	CMesh *pMeshField = nullptr;
//	if (pMeshField == nullptr)
//	{
//		// 動的メモリ確保
//		pMeshField = new CMesh();
//
//		// NULLチェックe
//		if (pMeshField != nullptr)
//		{
//			pMeshField->m_rot = rot;			// 回転
...
//// ポリゴンの初期化処理
////=============================================================================
//HRESULT CMesh::Init(D3DXVECTOR3 pos, D3DXVECTOR3 size)
//{
...
//
//	// シーンがnullになるまで通る
//	while (pScene != nullptr && !m_vtxWorld.empty())
//	{
//		// 次のシーンを取得
...
//
//				// 当たり判定
//				if (LineCollisionMesh(pScene, &nID[0]) == true)
//				{
//
//					// 重力をつけるとトランポリンになる
...
//// 頂点座標の設定
////------------------------------------------------------------
//void CMesh::SetPos(D3DXVECTOR3 pos, D3DXVECTOR3 scale)
//{
//	CScene::SetPos(pos);
...
////テクスチャの設定
////------------------------------------------------------------
//void CMesh::SetTex(int nAnim, int nPartU)
//{
//	VERTEX_3D *pVtx;
//
//	m_pVtxBuff->Lock(0, 0, (void**)&pVtx, 0);
...
//	m_pVtxBuff->Unlock();
//}
//void CMesh::SetCol(D3DXCOLOR col)
//{
//	VERTEX_3D *pVtx;
//
//	m_pVtxBuff->Lock(0, 0, (void**)&pVtx, 0);
...
//// ポリゴン(フィールド)と線の当たり判定
////=============================================================================
//bool CMesh::LineCollisionMesh(CScene *pScene, const int *nVtx)
//{
